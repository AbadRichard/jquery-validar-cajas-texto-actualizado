  ...
  $(document).ready(function(){ 
      ...
      //identificar los campos en blanco
        $('#txtNombre').blur(function(){
             var mensaje1 = $('#txtNombre').val();
             if(mensaje1==""){ $('#MensError1').html("Este campo es Obligatorio");}});
        $('#txtCorreo').blur(function (){
             var mensaje2=$('#txtCorreo').val();
             if(mensaje2==""){$('#MensError2').html("Este campo es Obligatorio"); }   });
        $('#txtPassword1').blur(function (){
               var mensaje3=$('#txtPassword1').val();
             if(mensaje3==""){ $('#MensError3').html("Este campo es Obligatorio");}});
        $('#txtPassword2').blur(function (){
               var mensaje4=$('#txtPassword2').val();
             if(mensaje4==""){ $('#MensError4').html("Este campo es Obligatorio");}});
         //borrar las barras de Error cuando se hace click en caja de texto
         //usamos para todo los cajas de texto
         $('#txtNombre').click(function (){ $('#MensError1').empty();  });
         $('#txtCorreo').click(function (){ $('#MensError2').empty(); });
         $('#txtPassword1').click(function (){ $('#MensError3').empty(); });
         $('#txtPassword2').click(function (){$('#MensError4').empty(); });
        
        $('#txtPassword2').keydown(function (){
